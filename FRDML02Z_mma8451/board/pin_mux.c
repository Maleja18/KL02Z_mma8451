...
void BOARD_ledPins(void)
{
    ...
    PORT_SetPinConfig(BOARD_LEDPINS_LED_BLUE_PORT, BOARD_LEDPINS_LED_BLUE_PIN, &LED_BLUE);
    ...
    PORT_SetPinConfig(BOARD_LEDPINS_LED_RED_PORT, BOARD_LEDPINS_LED_RED_PIN, &LED_RED);
    ...
    PORT_SetPinConfig(BOARD_LEDPINS_LED_GREEN_PORT, BOARD_LEDPINS_LED_GREEN_PIN, &LED_GREEN);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
